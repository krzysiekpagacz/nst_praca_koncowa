...
CHAPTER_1_TITLE = 'Introduction and goal of the work'
...
CHAPTER_21_INPUT = '../resources/text/21.txt'
CHAPTER_221_INPUT = '../resources/text/221.txt'
CHAPTER_222_INPUT = '../resources/text/222.txt'
CHAPTER_223_INPUT = '../resources/text/223.txt'
CHAPTER_224_INPUT = '../resources/text/224.txt'
CHAPTER_225_INPUT = '../resources/text/225.txt'
CHAPTER_226_INPUT = '../resources/text/226.txt'
CHAPTER_22_INPUT = '../resources/text/22.txt'
CHAPTER_23_INPUT = '../resources/text/23.txt'
CHAPTER_231_INPUT = '../resources/text/231.txt'
CHAPTER_232_INPUT = '../resources/text/232.txt'
CHAPTER_233_INPUT = '../resources/text/233.txt'
CHAPTER_24_INPUT = '../resources/text/24.txt'
CHAPTER_241_INPUT = '../resources/text/241.txt'
CHAPTER_25_INPUT = '../resources/text/25.txt'
CHAPTER_3_TITLE = 'Transport Layer Protocols'
CHAPTER_3_INPUT = '../resources/text/protocols.txt'
CHAPTER_4_TITLE = 'Services'
CHAPTER_4_INPUT = '../resources/text/ports.txt'
CHAPTER_5_TITLE = 'Summary of data traffic'
CHAPTER_5_INPUT = '../resources/text/summary.txt'
CHAPTER_51_INPUT = '../resources/text/flows.txt'
CHAPTER_52_INPUT = '../resources/text/bytes.txt'
CHAPTER_53_INPUT = '../resources/text/packets.txt'
CHAPTER_54_INPUT = '../resources/text/bps.txt'
CHAPTER_55_INPUT = '../resources/text/pps.txt'
CHAPTER_56_INPUT = '../resources/text/bpp.txt'
CHAPTER_6_TITLE = 'Conclusion'
CHAPTER_6_INPUT = '../resources/text/conclusion.txt'
CHAPTER_7_TITLE = 'References'
CHAPTER_7_INPUT = '../resources/text/ref.txt'
